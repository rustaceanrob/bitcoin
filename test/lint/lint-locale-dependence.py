...
#
# bitcoind does not opt in to localization -- no call to setlocale(LC_ALL, "")
# is made and the environment variables LC_* are thus ignored. bitcoind is
# guaranteed to run with the classic locale ("C").
