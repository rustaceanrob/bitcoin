...
BOOST_FIXTURE_TEST_CASE(wallet_coinsresult_test, BasicTestingSetup)
{
...

    {
        ...
        for (const auto& out: outs_to_remove) {
            ...
            CHECK_NO_DISPLAY(it == updated_coins.end());
        }
