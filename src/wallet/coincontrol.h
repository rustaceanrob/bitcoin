...
public:
    ...
    //! True if we are funding a transaction with at least one silent payments recipient.
    //! Requires at least one BIP352-eligible input for shared secret derivation.
