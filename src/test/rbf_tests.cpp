...
BOOST_FIXTURE_TEST_CASE(calc_feerate_diagram_rbf, TestChain100Setup)
{
    ...
    // Replacement of size 1
    {
        ...
        BOOST_CHECK_EQUAL_COLLECTIONS(replace_one->first.begin(), replace_one->first.end(), expected_old_chunks.begin(), expected_old_chunks.end());
        std::vector<FeeFrac> expected_new_chunks{{0, entry_replacement.GetAdjustedWeight()}};
        BOOST_CHECK_EQUAL_COLLECTIONS(replace_one->second.begin(), replace_one->second.end(), expected_new_chunks.begin(), expected_new_chunks.end());
    }
    ...
    // Non-zero replacement fee/size
    {
        ...
        BOOST_CHECK_EQUAL_COLLECTIONS(replace_one_fee->first.begin(), replace_one_fee->first.end(), expected_old_diagram.begin(), expected_old_diagram.end());
        std::vector<FeeFrac> expected_new_diagram{{high_fee, entry_replacement.GetAdjustedWeight()}};
        BOOST_CHECK_EQUAL_COLLECTIONS(replace_one_fee->second.begin(), replace_one_fee->second.end(), expected_new_diagram.begin(), expected_new_diagram.end());
    }
...

    {
        ...
        BOOST_CHECK_EQUAL_COLLECTIONS(replace_single_chunk->first.begin(), replace_single_chunk->first.end(), expected_old_chunks.begin(), expected_old_chunks.end());
        std::vector<FeeFrac> expected_new_chunks{{high_fee, entry_replacement.GetAdjustedWeight()}};
        BOOST_CHECK_EQUAL_COLLECTIONS(replace_single_chunk->second.begin(), replace_single_chunk->second.end(), expected_new_chunks.begin(), expected_new_chunks.end());
    }
    ...
    // Conflict with the 2nd tx, resulting in new diagram with three entries
    {
        ...
        std::vector<FeeFrac> expected_old_chunks{{low_fee + high_fee, low_size + high_size}};
        BOOST_CHECK_EQUAL_COLLECTIONS(replace_cpfp_child->first.begin(), replace_cpfp_child->first.end(), expected_old_chunks.begin(), expected_old_chunks.end());
        std::vector<FeeFrac> expected_new_chunks{{high_fee, entry_replacement.GetAdjustedWeight()}, {low_fee, low_size}};
        BOOST_CHECK_EQUAL_COLLECTIONS(replace_cpfp_child->second.begin(), replace_cpfp_child->second.end(), expected_new_chunks.begin(), expected_new_chunks.end());
    }
...

    {
        ...
        BOOST_CHECK_EQUAL_COLLECTIONS(replace_two_chunks_single_cluster->first.begin(), replace_two_chunks_single_cluster->first.end(), expected_old_chunks.begin(), expected_old_chunks.end());
        std::vector<FeeFrac> expected_new_chunks{{high_fee, low_size_2}};
        BOOST_CHECK_EQUAL_COLLECTIONS(replace_two_chunks_single_cluster->second.begin(), replace_two_chunks_single_cluster->second.end(), expected_new_chunks.begin(), expected_new_chunks.end());
    }
