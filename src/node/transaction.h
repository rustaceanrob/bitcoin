 ...
 * by these RPCs. This can be overridden with the maxfeerate argument.
 */
 ...
 * by these RPCs. This can be overridden with the maxburnamount argument.
 */
 ...
 * If block_index is provided, check for tx by reading entire block from disk.
 *
